                        ...
                        <div>
                            ...
                            <ul>
                                ...
                                <p><li><label className="label">员工姓名：</label>
                                    <input type="text" className="input" name="姓名" placeholder="请输入姓名" />
                                    <font size="3" color="red">*</font>
                                </li></p>
                                <p><li><label className="label">员工工号：</label>
                                    <input type="text" className="input" name="工号" placeholder="请输入工号" />
                                    <font size="3" color="red">*</font>
                                </li></p>
                                <p><li><label className="label">岗位名称：</label>
                                    <input type="text" className="input" name="岗位" placeholder="请输入岗位" />
                                    <font size="3" color="red">*</font>
                                </li></p>
                                ...
                                <p><li><label className="label">工作电话：</label>
                                    <input type="text" className="input" name="工作电话" placeholder="请输入工作电话" />
                                    <font size="3" color="red">*</font>
                                </li></p>
                                <p><li><label className="label">手机号码：</label>
                                    <input type="text" className="input" name="手机号码" placeholder="请输入手机号" />
                                    <font size="3" color="red">*</font>
                                </li></p>
                                <p><li><label className="label">邮箱：&nbsp;&nbsp;</label>
                                    <input type="text" className="input" name="邮箱" placeholder="请输入邮箱" />
                                    <font size="3" color="red">*</font>
                                </li></p>
                                <p><li><label className="label">工作QQ：</label>
                                    <input type="text" className="input" name="工作QQ" placeholder="请输入QQ" />
                                    <font size="3" color="red">*</font>
                                </li></p>
                                <p><li><label className="label">工作微信：</label>
                                    <input type="text" className="input" name="工作微信" placeholder="请输入微信" />
                                </li></p>
